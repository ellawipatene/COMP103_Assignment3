...
public class Patient implements Comparable<Patient>{
    ...
    private int currWaitTime = 0;  // waiting time for each depatment
    ...
    /**
     * Returns the amount of time they have waited at each department
     */
    public int getCurrWaitTime(){
        int temp = currWaitTime; 
        currWaitTime = 0; // resets the curent waiting time
        return temp; 
    }
    ...
    public int compareTo(Patient other){
        ...
        if(this.priority < other.priority){return -1;}
            ...
            if(this.totalWaitTime > other.totalWaitTime){return -1;}
            else if(this.totalWaitTime < other.totalWaitTime){return 1;}
            else{return 0;}
        }
    }
